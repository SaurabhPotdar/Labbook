...
<tr>
<td><input type="text" value="${list.traineeId}" name="id" /></td>
<td><input type="text" value="${list.traineeName}" name="name" /></td>
<td><input type="text" value="${list.traineeLocation}" name="location"/></td>
<td><input type="text" value="${list.traineeDomain}" name="domain"/></td>
